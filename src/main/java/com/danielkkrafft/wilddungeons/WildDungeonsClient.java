...
//        event.registerEntityRenderer(WDEntities.AMOGUS.get(), AmogusRenderer::new); TODO - Uncommment mobs as fixed for 1.21.11
...
//        event.registerBlockEntityRenderer(WDBlockEntities.TOXIC_GAS_ENTITY.get(), GasBlockRenderer::new);
    ...
    public static void onRegisterClientExtensions(RegisterClientExtensionsEvent event) {
        ...
        event.registerFluidType(new IClientFluidTypeExtensions() {
            ...
            private static final Identifier LIFE_UNDERWATER = rl("textures/block/life_underwater.png");
            private static final Identifier LIFE_STILL = rl("block/life_still");
            private static final Identifier LIFE_FLOW = rl("block/life_flow");
        ...
        //TODO - Fix for 1.21.11 to match new rendering system
//        ItemBlockRenderTypes.setRenderLayer(WDFluids.LIFE_LIQUID.get(), RenderTypes.translucent());
...
//        ItemBlockRenderTypes.setRenderLayer(WDBlocks.PUTRID_EGG.get(), RenderType.cutoutMipped());
        ...
        event.registerFluidType(new IClientFluidTypeExtensions() {
            ...
            private static final Identifier TOXIC_UNDERWATER = rl("textures/block/toxic_underwater.png");
            private static final Identifier TOXIC_STILL = rl("block/toxic_still");
            private static final Identifier TOXIC_FLOW = rl("block/toxic_flow");
...
//        event.registerLayerDefinition(BusinessGolemModel.LAYER_LOCATION, BusinessGolemModel::createBodyLayer); - TODO Uncomment once respective mobs are fixed for 1.21.11
...
//    @SubscribeEvent TODO - Fix for 1.21.11
