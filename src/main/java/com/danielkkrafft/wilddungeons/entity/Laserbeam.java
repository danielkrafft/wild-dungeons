...
//        getEntityData().set(YAW, input.getFloatOr("Yaw", 0));
//        getEntityData().set(PITCH, input.getFloatOr("Pitch", 0));
//        getEntityData().set(RADIUS, input.getFloatOr("BeamRadius", 0));
//        getEntityData().set(LENGTH, input.getFloatOr("BeamLength", 0));
//        getEntityData().set(DAMAGE, input.getFloatOr("BeamDamage", 0));
//        getEntityData().set(RANGE, input.getFloatOr("BeamRange", 0));
//        getEntityData().set(LIFETIMEAFTERHIT, input.getIntOr("BeamCounter", 0));
//        getEntityData().set(EXPLOSION, input.getBooleanOr("Explosion", false));
//        getEntityData().set(FIRE_DEBRIS, input.getBooleanOr("FireDebris", false));
//        getEntityData().set(EXPLOSION_RADIUS, input.getFloatOr("ExplosionRadius", 0));
//        getEntityData().set(CHARGETIME, input.getIntOr("ChargeTime", 0));
//    }
//
//    @Override
...
//        output.putFloat("Yaw", getEntityData().get(YAW));
//        output.putFloat("Pitch", getEntityData().get(PITCH));
//        output.putFloat("BeamRadius", getEntityData().get(RADIUS));
//        output.putFloat("BeamLength", getEntityData().get(LENGTH));
//        output.putFloat("BeamDamage", getEntityData().get(DAMAGE));
//        output.putFloat("BeamRange", getEntityData().get(RANGE));
//        output.putInt("BeamCounter", getEntityData().get(LIFETIMEAFTERHIT));
//        output.putBoolean("Explosion", getEntityData().get(EXPLOSION));
//        output.putBoolean("FireDebris", getEntityData().get(FIRE_DEBRIS));
//        output.putFloat("ExplosionRadius", getEntityData().get(EXPLOSION_RADIUS));
//        output.putInt("ChargeTime", getEntityData().get(CHARGETIME));
//    }
//
