...
public class CondemnedGuardianGlowLayer extends GeoRenderLayer<CondemnedGuardian> {
    ...
    public CondemnedGuardianGlowLayer(GeoRenderer<CondemnedGuardian> entityRendererIn) {
    ...
    @Override
    protected ResourceLocation getTextureResource(CondemnedGuardian animatable) {
