...
import com.danielkkrafft.wilddungeons.entity.model.PiercingArrowModel;
...
public class PiercingArrowRenderer extends GeoEntityRenderer<PiercingArrow>
{
    ...
    {
        super(context,new PiercingArrowModel());
    }
    @Override
    public void actuallyRender(PoseStack poseStack, PiercingArrow entity, BakedGeoModel model, @Nullable RenderType renderType, MultiBufferSource
            bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour)
    {
