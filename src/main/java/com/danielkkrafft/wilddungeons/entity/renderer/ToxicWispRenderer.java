...
public class ToxicWispRenderer extends MobRenderer<ToxicWisp, ToxicWispModel<ToxicWisp>> {
    ...
    public ToxicWispRenderer(EntityRendererProvider.Context context, boolean isLarge) {
        super(context, new ToxicWispModel<>(context.bakeLayer(
                isLarge ? ToxicWispModel.LARGE_LAYER_LOCATION : ToxicWispModel.SMALL_LAYER_LOCATION)), 0.25f);
