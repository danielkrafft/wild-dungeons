...
//
//    private static final Identifier RIFT_TEX = WildDungeons.rl("textures/entity/rifts/rift_tex.png");
//
//    private static final Identifier MESSAGE_BUBBLE_TEXTURE = WildDungeons.rl("textures/gui/sprites/hud/message_bubble.png");
//    private static final Identifier PERK_RING_TEXTURE = WildDungeons.rl("textures/gui/sprites/hud/perk_ring.png");
//    private static final Identifier ITEM_RING_TEXTURE = WildDungeons.rl("textures/gui/sprites/hud/item_ring.png");
...
//
//    @Override
//    public Identifier getTextureLocation(Offering entity) {return TextureAtlas.LOCATION_BLOCKS;}
//
...
//            RenderType PERK_RENDERTYPE = RenderTypes.entityCutout(perk.getTextureLocation());
...
//
//            PoseStack.Pose posestack$pose = poseStack.last();
//            VertexConsumer vertexconsumer = buffer.getBuffer(RenderTypes.itemEntityTranslucentCull(RIFT_ANIMATION.getCurrentFrame()));
//
...
//
//            vertexconsumer = buffer.getBuffer(RenderTypes.breezeEyes(RIFT_EFFECT_ANIMATION.getCurrentFrame()));
//
//            vertex(vertexconsumer, posestack$pose, -1.0f, -1.0f, 0.0f, 1.0f, 0xF000F0, 1.0f, entity.getSecondaryColor());
//            vertex(vertexconsumer, posestack$pose, 1.0f, -1.0f, 1.0f, 1.0f, 0xF000F0, 1.0f, entity.getSecondaryColor());
//            vertex(vertexconsumer, posestack$pose, 1.0f, 1.0f, 1.0f, 0.0f, 0xF000F0, 1.0f, entity.getSecondaryColor());
