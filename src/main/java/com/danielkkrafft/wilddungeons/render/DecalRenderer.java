...
//
//@EventBusSubscriber
//public class DecalRenderer { TODO - Fix for 1.21.11
...
//
//        public Decal(Identifier texture, float originX, float originY, float originZ, float width, float height, Direction.Axis axis, int color, ResourceKey<Level> dimension) {
