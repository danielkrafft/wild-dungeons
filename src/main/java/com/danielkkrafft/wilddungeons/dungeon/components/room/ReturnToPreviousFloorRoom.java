...
public class ReturnToPreviousFloorRoom extends DungeonRoom {
    public ReturnToPreviousFloorRoom(DungeonBranch branch, String templateKey, BlockPos position, TemplateOrientation orientation) {
