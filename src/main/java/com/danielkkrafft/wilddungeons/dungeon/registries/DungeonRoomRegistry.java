...
public class DungeonRoomRegistry { //TODO this should probably be a json/nbt based data oriented approach, with a built-in editor item. This is already getting extremely difficult to maintain
    ...
    public static final DungeonRoomTemplate SCIFI_ARENA_COMBAT_ROOM = createCombat("special/gauntlet/scifi_arena_combat_room").set(DESTRUCTION_RULE,DestructionRule.SHELL_CLEAR).set(DIFFICULTY_MODIFIER, 7.0).set(WAVE_SIZE, 10).set(ROOM_CLEAR_REWARD_POOL, OfferingTemplatePoolRegistry.SCIFI_WEAPONS_POOL);
    ...
    public static final DungeonRoomTemplate TRIAL_ARENA_COMBAT_ROOM = createCombat("special/gauntlet/trial_arena_combat_room").set(DESTRUCTION_RULE,DestructionRule.SHELL_CLEAR).set(DIFFICULTY_MODIFIER, 7.0).set(WAVE_SIZE, 10).set(ROOM_CLEAR_REWARD_POOL, OfferingTemplatePoolRegistry.WIND_WEAPONS_POOL);
    ...
    public static final DungeonRoomTemplate GENERAL_ARENA_COMBAT_ROOM = createCombat("special/gauntlet/general_arena_combat_room").set(DESTRUCTION_RULE,DestructionRule.SHELL_CLEAR).set(DIFFICULTY_MODIFIER, 7.0).set(WAVE_SIZE, 10).set(ROOM_CLEAR_REWARD_POOL, OfferingTemplatePoolRegistry.GENERAL_WEAPONS_POOL);
