...
public class OfferingTemplateRegistry {
    ...
    public static final OfferingTemplate OVERWORLD_TEST_RIFT = new DungeonRegistration.OfferingTemplate("OVERWORLD_TEST_RIFT", RIFT, 1, "wd-mega_dungeon", XP_LEVEL, 30, 1.5f).setRenderScale(3.0f).setSoundLoop(WDSoundEvents.RIFT_AURA.value());
