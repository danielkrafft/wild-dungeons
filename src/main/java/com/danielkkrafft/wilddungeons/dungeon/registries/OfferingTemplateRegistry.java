...
//    public static final OfferingTemplate REGENERATION_POTION = createItem("REGENERATION_POTION", ItemTemplateRegistry.REGENERATION_POTION_SPLASH, OVERWORLD, 8, 1.5f);
    ...
    public static final OfferingTemplate VILLAGE_SWORD_DAMAGE = createPerk("VILLAGE_SWORD_DAMAGE", PerkRegistry.SWORD_DAMAGE, OVERWORLD, 20, 1.5f).setCostItem(Items.EMERALD,100);
    public static final OfferingTemplate VILLAGE_AXE_DAMAGE = createPerk("VILLAGE_AXE_DAMAGE", PerkRegistry.AXE_DAMAGE, OVERWORLD, 20, 1.5f).setCostItem(Items.EMERALD,100);
    public static final OfferingTemplate VILLAGE_BOW_DAMAGE = createPerk("VILLAGE_BOW_DAMAGE", PerkRegistry.BOW_DAMAGE, OVERWORLD, 20, 1.5f).setCostItem(Items.EMERALD,100);
    public static final OfferingTemplate VILLAGE_EXTRA_LIFE = createPerk("VILLAGE_EXTRA_LIFE", PerkRegistry.EXTRA_LIFE, OVERWORLD, 20, 1.5f).setCostItem(Items.EMERALD,100);
    public static final OfferingTemplate VILLAGE_FIRE_RESIST = createPerk("VILLAGE_FIRE_RESIST", PerkRegistry.FIRE_RESIST, OVERWORLD, 20, 1.5f).setCostItem(Items.EMERALD,100);
    public static final OfferingTemplate VILLAGE_STRENGTH = createPerk("VILLAGE_STRENGTH", PerkRegistry.STRENGTH, OVERWORLD, 20, 1.5f).setCostItem(Items.EMERALD,100);
    public static final OfferingTemplate VILLAGE_NIGHT_VISION = createPerk("VILLAGE_NIGHT_VISION", PerkRegistry.NIGHT_VISION, OVERWORLD, 20, 1.5f).setCostItem(Items.EMERALD,100);
    public static final OfferingTemplate VILLAGE_HEALTH_BOOST = createPerk("VILLAGE_HEALTH_BOOST", PerkRegistry.HEALTH_BOOST, OVERWORLD, 20, 1.5f).setCostItem(Items.EMERALD,100);
    public static final OfferingTemplate VILLAGE_MOVEMENT_SPEED = createPerk("VILLAGE_MOVEMENT_SPEED", PerkRegistry.MOVEMENT_SPEED, OVERWORLD, 20, 1.5f).setCostItem(Items.EMERALD,100);
    public static final OfferingTemplate VILLAGE_DIG_SPEED = createPerk("VILLAGE_DIG_SPEED", PerkRegistry.DIG_SPEED, OVERWORLD, 20, 1.5f).setCostItem(Items.EMERALD,100);
    public static final OfferingTemplate VILLAGE_BIG_ABSORPTION = createPerk("VILLAGE_BIG_ABSORPTION", PerkRegistry.BIG_ABSORPTION, OVERWORLD, 20, 1.5f).setCostItem(Items.EMERALD,100);
    public static final OfferingTemplate VILLAGE_ATTACK_SPEED = createPerk("VILLAGE_ATTACK_SPEED", PerkRegistry.ATTACK_SPEED, OVERWORLD, 20, 1.5f).setCostItem(Items.EMERALD,100);
    public static final OfferingTemplate VILLAGE_POISON_IMMUNITY = createPerk("VILLAGE_POISON_IMMUNITY", PerkRegistry.POISON_IMMUNITY, OVERWORLD, 20, 1.5f).setCostItem(Items.EMERALD,100);
    public static final OfferingTemplate VILLAGE_STEP_HEIGHT = createPerk("VILLAGE_STEP_HEIGHT", PerkRegistry.STEP_HEIGHT, OVERWORLD, 20, 1.5f).setCostItem(Items.EMERALD,100);
    ...
    public static final OfferingTemplate VILLAGE_HEADQUARTERS_GAUNTLET_RIFT = createRift("VILLAGE_HEADQUARTERS_GAUNTLET_RIFT", "wd-village_dungeon_gauntlet", OVERWORLD, 30, 1.5f).setSoundLoop(WDSoundEvents.RIFT_AURA.value());
