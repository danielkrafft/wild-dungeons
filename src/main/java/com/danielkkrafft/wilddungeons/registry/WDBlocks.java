...
public class WDBlocks {
    ...
    public static final DeferredBlock<Block> DETONITE_ORE = registerWithItem("detonite_ore", () -> new DetoniteBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(0.3F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    public static final DeferredBlock<Block> DETONITE_BLOCK = registerWithItem("detonite_block", () -> new DetoniteBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(0.3F, 6.0F).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    public static final DeferredBlock<Block> DETONITE_CRYSTAL_BLOCK = registerWithItem("detonite_crystal_block", () -> new DetoniteBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_YELLOW).requiresCorrectToolForDrops().strength(0.3F, 6.0F).sound(SoundType.AMETHYST).requiresCorrectToolForDrops()));
    public static final DeferredBlock<Block> SMALL_DETONITE_BUD = registerWithItem("small_detonite_bud", () -> new DetoniteClusterBlock(3f,4f,BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_YELLOW).requiresCorrectToolForDrops().strength(0.3F, 6.0F).sound(SoundType.AMETHYST).requiresCorrectToolForDrops()));
    public static final DeferredBlock<Block> MEDIUM_DETONITE_BUD = registerWithItem("medium_detonite_bud", () -> new DetoniteClusterBlock(4f,3f,BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_YELLOW).requiresCorrectToolForDrops().strength(0.3F, 6.0F).sound(SoundType.AMETHYST).requiresCorrectToolForDrops()));
    public static final DeferredBlock<Block> LARGE_DETONITE_BUD = registerWithItem("large_detonite_bud", () -> new DetoniteClusterBlock(5f,3f,BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_YELLOW).requiresCorrectToolForDrops().strength(0.3F, 6.0F).sound(SoundType.AMETHYST).requiresCorrectToolForDrops()));
    public static final DeferredBlock<Block> DETONITE_CLUSTER = registerWithItem("detonite_cluster", () -> new DetoniteClusterBlock(7f,3f,BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_YELLOW).requiresCorrectToolForDrops().strength(0.3F, 6.0F).sound(SoundType.AMETHYST).requiresCorrectToolForDrops()));
