...
public class WDItems {
    ...
    public static final DeferredItem<Item> WD_DUNGEON_KEY = ITEMS.register("wd_dungeon_key", () -> new DungeonKeyItem(new Item.Properties().stacksTo(1).fireResistant().rarity(Rarity.RARE)));
}
